...
export const Route = createFileRoute("/_dashboard/superadmin/resllers")({
          ...
          <tbody>
            {resellers.length === 0 ? (
              ...
              resellers.map((reseller: any) => (
                ...
                >
                  <td className="px-4 py-3 text-white">{reseller.name}</td>
                  <td className="px-4 py-3 text-muted-foreground">
                    {reseller.email}
                  </td>
                  <td className="px-4 py-3">
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${reseller.isActive ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"}`}
                    >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => toggleUser(reseller._id)}
                      ...
                      <button
                        onClick={() => deleteUser(reseller._id)}
